...
if (isset($_SESSION['username'])) {
    ...
    $sessionHTML = "<div class='header-img'><p id='$username'>Bienvenido,<br><a href='user.html' id='w_user' style='color: #00e861; font-weight: bold; font-size: large;'>$username</a></p>";
